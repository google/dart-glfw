...
main(List<String> args) async {
  var parser = new ArgParser()
    ...
    ..addOption('glfw3_path',
        ...
        abbr: 'g',
        valueHelp: 'path')
    ..addOption('dart_glfw_lib_path',
        help: 'path to directory containing glfw_extension.h',
        abbr: 'l',
        valueHelp: 'path',
        hide: true,
        defaultsTo: "")
  ...
  var trueGlfwPath = results['glfw3_path'];
  glfwPath = path.joinAll(path.split(trueGlfwPath).skip(pathStrip));
  glfwPath = '$glfwPath${path.separator}';

  thisPath = "../";
  if (results.wasParsed('dart_glfw_lib_path')) {
    thisPath =
        path.joinAll(path.split(results['dart_glfw_lib_path']).skip(pathStrip));
  ...
  var readStream = new File(path.join(trueGlfwPath, 'glfw3.h')).openRead();
  await for (var line
...
#include "${glfwPath}glfw3.h"
#include "${dartPath}dart_api.h"


#include "${thisPath}instantiate_glfw_classes.h"
