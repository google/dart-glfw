...
GLFWerrorfun glfwSetErrorCallback(
    GLFWerrorfun cbfun) native "glfwSetErrorCallback";
...
GLFWmonitorfun glfwSetMonitorCallback(
    GLFWmonitorfun cbfun) native "glfwSetMonitorCallback";
...
void glfwSetGammaRamp(
    GLFWmonitor monitor, GLFWgammaramp ramp) native "glfwSetGammaRamp";
void glfwDefaultWindowHints() native "glfwDefaultWindowHints";
void glfwWindowHint(int target, int hint) native "glfwWindowHint";
...
void glfwSetWindowShouldClose(
    GLFWwindow window, int value) native "glfwSetWindowShouldClose";
void glfwSetWindowTitle(
    GLFWwindow window, String title) native "glfwSetWindowTitle";
void glfwSetWindowPos(
    GLFWwindow window, int xpos, int ypos) native "glfwSetWindowPos";
void glfwSetWindowSize(
    GLFWwindow window, int width, int height) native "glfwSetWindowSize";
...
GLFWmonitor glfwGetWindowMonitor(
    GLFWwindow window) native "glfwGetWindowMonitor";
int glfwGetWindowAttrib(
    GLFWwindow window, int attrib) native "glfwGetWindowAttrib";
...
void glfwSetInputMode(
    GLFWwindow window, int mode, int value) native "glfwSetInputMode";
int glfwGetKey(GLFWwindow window, int key) native "glfwGetKey";
int glfwGetMouseButton(
    GLFWwindow window, int button) native "glfwGetMouseButton";
void glfwSetCursorPos(
    GLFWwindow window, double xpos, double ypos) native "glfwSetCursorPos";
GLFWcursor glfwCreateCursor(
    GLFWimage image, int xhot, int yhot) native "glfwCreateCursor";
GLFWcursor glfwCreateStandardCursor(
    int shape) native "glfwCreateStandardCursor";
...
GLFWkeyfun glfwSetKeyCallback(
    GLFWwindow window, GLFWkeyfun cbfun) native "glfwSetKeyCallback";
GLFWcharfun glfwSetCharCallback(
    GLFWwindow window, GLFWcharfun cbfun) native "glfwSetCharCallback";
...
GLFWscrollfun glfwSetScrollCallback(
    GLFWwindow window, GLFWscrollfun cbfun) native "glfwSetScrollCallback";
GLFWdropfun glfwSetDropCallback(
    GLFWwindow window, GLFWdropfun cbfun) native "glfwSetDropCallback";
...
void glfwSetClipboardString(
    GLFWwindow window, String string) native "glfwSetClipboardString";
String glfwGetClipboardString(
    GLFWwindow window) native "glfwGetClipboardString";
